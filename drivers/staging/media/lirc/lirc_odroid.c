...
static int gpio_in_pin = 209;
/* set the default GPIO output pin */
static int gpio_out_pin = 203;
...
MODULE_DESCRIPTION("Infra-red receiver and blaster driver for Odroid X/X2 GPIO (based on lirc_rpi).");
MODULE_AUTHOR("Xander Victory <xander@victory.id.au>");
MODULE_LICENSE("GPL");

module_param(gpio_out_pin, int, S_IRUGO);
MODULE_PARM_DESC(gpio_out_pin, "GPIO output/transmitter pin number of the Exynos processor"
		 " processor. "//Valid pin numbers are: 0, 1, 4, 8, 7, 9, 10, 11,"
		 /*" 14, 15, 17, 18, 21, 22, 23, 24, 25,*/" default 203 (GPX1.4, extension header pin 9)");

module_param(gpio_in_pin, int, S_IRUGO);
MODULE_PARM_DESC(gpio_in_pin, "GPIO input pin number of the Exynos processor. You MUST use an interrupt capable pin!"
		 /*" Valid pin numbers are: 0, 1, 4, 8, 7, 9, 10, 11, 14, 15,"
		 " 17, 18, 21, 22, 23, 24, 25,*/" default 209 (GPX2.1, extension header pin 4)");
